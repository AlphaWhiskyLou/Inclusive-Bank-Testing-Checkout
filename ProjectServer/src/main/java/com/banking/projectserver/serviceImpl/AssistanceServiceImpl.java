...
public class AssistanceServiceImpl implements AssistanceService {
    ...
    void setAssistanceRequestMapper(AssistanceRequestMapper assistanceRequestMapper){
        this.assistanceRequestMapper = assistanceRequestMapper;
    }
    void setBankAccountService(BankAccountService bankAccountService){
        this.bankAccountService = bankAccountService;
    }
    void setUtilityService(UtilityService utilityService) { this.utilityService = utilityService; }
    ...
    public boolean updateAssistanceRequestStatus(String assistanceID, int isFinished) throws Exception {
        if(isFinished==1){
            ...
            else if(assistanceRequest.getFunctionID()==7){
    ...
    @Override
    public List<AssistanceRequestDisp> getAssistanceRequestByTransactionID(String transactionID){ //Deprecated
